...
func (r ApiListClusterSizesRequest) Execute() ([]ClusterSize, *http.Response, error) {
	return r.ApiService.ListClusterSizesExecute(r)
}
...
func (a *PlatformApiService) ListClusterSizesExecute(r ApiListClusterSizesRequest) ([]ClusterSize, *http.Response, error) {
	var (
		...
		formFiles           []formFile
		localVarReturnValue []ClusterSize
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlatformApiService.ListClusterSizes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/platforms/{platform}/sizes"
...
func (a *PlatformApiService) ListPlatformsExecute(r ApiListPlatformsRequest) ([]Platform, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlatformApiService.ListPlatforms")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/platforms"
...
func (a *PlatformApiService) ListRegionsExecute(r ApiListRegionsRequest) ([]Region, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlatformApiService.ListRegions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/platforms/{platform}/regions"
	localVarPath = strings.Replace(localVarPath, "{"+"platform"+"}", url.PathEscape(parameterToString(r.platform, "")), -1)
